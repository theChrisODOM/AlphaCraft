...
public class AlphacraftBiomesManager
{
    ...
    public static void setupBiomes()
    {
        ...
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(END_FOREST.get(), 10));
    ...
    public static final RegistryObject<EndForest> END_FOREST = BIOMES.register("end_forest", EndForest::new);
    //Carvers
