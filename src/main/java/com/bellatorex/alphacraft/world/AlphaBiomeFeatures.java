...
public class AlphaBiomeFeatures {
    ...
    public static final BlockClusterFeatureConfig BRIGHT_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegistry.BRIGHT_FLOWER.get().getDefaultState()), SimpleBlockPlacer.field_236447_c_)).tries(64).build();
    ...
    public static void addBrightFlowers(Biome biomeIn) {
        biomeIn.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.FLOWER.withConfiguration(BRIGHT_FLOWER_CONFIG).withPlacement(Placement.COUNT_HEIGHTMAP_32.configure(new FrequencyConfig(2))));
    }
}