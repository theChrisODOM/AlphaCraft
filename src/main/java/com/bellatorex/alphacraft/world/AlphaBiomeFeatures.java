...
public class AlphaBiomeFeatures {
    ...
    public static final BaseTreeFeatureConfig DARK_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegistry.DARK_LOG.get().getDefaultState()), new SimpleBlockStateProvider(BlockRegistry.DARK_LEAVES.get().getDefaultState()), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(5, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build();
