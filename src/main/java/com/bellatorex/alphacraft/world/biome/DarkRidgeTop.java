...
public class DarkRidgeTop extends Biome {
    ...
    public static final BlockState DARK_STONE = BlockRegistry.DARK_STONE.get().getDefaultState();

    public DarkRidgeTop() {
        super((new Builder()).
                surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(DARK_STONE, DARK_DIRT_BLOCK, DARK_DIRT_BLOCK))
